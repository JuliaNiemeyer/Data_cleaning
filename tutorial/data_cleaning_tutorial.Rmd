...
#mudar para uma das minhas sp. *Blastocerus dichotomus*
...
#no meu caso só tem um nome: "Blastocerus dichotomus (Illiger, 1815)" 
...
write.csv(occs.new.geo2, 
          "../data_ju/data_coordinate_check.csv", 
          row.names = FALSE)
```
